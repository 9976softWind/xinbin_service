...
public class GlobalExceptionHandler {
    ...
    public <T> Result<T> handleInterfaceException(Throwable e) {
        return Result.failed("当前用户无权限");
    }
...
//    @ResponseStatus(HttpStatus.NOT_FOUND)
//    public BaseResponse exception(DeviceNotFoundException e) {
//        BaseResponse response = new BaseResponse();
//        response.setCode(DEVICE_NOT_FOUND);
//        response.setMsg("no device found");
